...
var bee;
var score=0;
var storyb,insb,playb,homeb,mainb;
var mask=0;
var bird;
var shoot;
var city;
...
cityAnimation,lightpostAnimation,playbAnimation,insbAnimation,storybAnimation,homebAnimation,mainbAnimation,busAnimation,
...
shootingAnimation,vAnimation,antivirusAnimation,lotusAnimation,bAnimation,rainAnimation;
var man,manh1,manh2,manh3,manh4,manh5,saveSound;
var BEGIN=0; 
var PLAY=1;
var WIN;
var LOSE;
...
//loading all buttons animation.
playbAnimation=loadAnimation("play button.png");
insbAnimation=loadAnimation("instructions button.png");
storybAnimation=loadAnimation("story button.png");
homebAnimation=loadAnimation("home button.png");
mainbAnimation=loadAnimation("main button.png");
//loading game objects.
...
//different buttons.
mainb=createSprite(150,220);
mainb.addAnimation("mainb",mainbAnimation);
mainb.scale=0.6;

playb=createSprite(50,100);
playb.addAnimation("playb",playbAnimation);
playb.scale=0.6;
playb.visible=false;

insb=createSprite(-50,200);
insb.addAnimation("insb",insbAnimation);
insb.scale=0.6;
insb.visible=false;

storyb=createSprite(50,325);
storyb.addAnimation("storyb",storybAnimation);
storyb.scale=0.6;
